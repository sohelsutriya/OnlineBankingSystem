...
import com.cg.obs.exception.AccountNotFoundException;
...
public class FundTransferService {
	...
	public Account getAccountByAccountNo(String accountNo) throws AccountNotFoundException {
		if (ifAccountExist(accountNo)) {
	...
	public boolean ifAccountExist(String accountNo) {
		return restTemplate
				.getForEntity("http://localhost:5060/accounts/accounts/ifaccountexist/" + accountNo, Boolean.class)
				.getBody();
	}
	...
	public void postTransaction(Transaction transaction) {
		...
		try {
			...
			ResponseEntity<String> result = restTemplate.postForEntity(uri, transaction, String.class);
